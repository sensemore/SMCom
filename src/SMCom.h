...
public:
	...
	virtual void rx_event_handler_callback(SMCom_event_types event, SMCom_Status_t status, const CT * packet) = 0;
	virtual void tx_event_handler_callback(SMCom_event_types event, SMCom_Status_t status, const CT * packet) = 0;
